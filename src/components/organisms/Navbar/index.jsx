...
export const Navbar = () => {
  return (
    <header className="flex flex-row bg-[#F0F2F5] gap-5 w-full h-[15vh] text-lg px-[15vh] items-center">
      ...
      <nav className="flex flex-row items-center justify-between w-full ">
        ...
        <div className="flex flex-row gap-5">
          <Button padding="1" width="100" size="md" variant="primary">
            Register
          </Button>
          <Button padding="1" width="100" size="md" variant="primary-outline">
            Login
          </Button>
        </div>
      </nav>
